...
def check_all_messages(message):
        ...
        response('Siempre a la orden', ['gracias', 'te lo agradezco'], single_response=True)
        response('No cabe duda que el asistente del jorch ', ['mejor','maestro ', 'quien','es' ], single_response=True)
